...
from myFisrtApp.models import Si_Personnel
from myFisrtApp.models import Si_View_Ls
from myFisrtApp.models import Si_Statut
from myFisrtApp.models import Si_Ec

from myFisrtApp.forms import SelectNom
import datetime
...
def other(request):
    perso = Si_Personnel.objects.get(id=2)
    context = {
...
def statut(request):
    statuts = Si_Statut.objects.all()
    return render(request, 'statut.html',{'statuts': statuts})
